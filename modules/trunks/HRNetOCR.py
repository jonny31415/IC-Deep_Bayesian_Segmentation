...
from models.custom_layers import ConvolutionBnActivation, BottleneckBlock, HighResolutionModule, \
    SpatialGatherModule, SpatialOCRModule
import tensorflow.keras.backend as K

class HRNetOCR(tf.keras.Model):
    def __init__(self, input_shape, n_classes, filters=64, final_activation="softmax",
...
def getHRNetOCR(input_shape, n_classes):
    return HRNetOCR(input_shape, n_classes)